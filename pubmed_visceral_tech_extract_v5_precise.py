...
# -*- coding: utf-8 -*-
"""
PubMed extraction v5: visceral/abdominal surgery operations/diseases/techniques
...
Run:
    python pubmed_visceral_tech_extract_v5_precise.py
"""
...
TOOL = "visceral_surgery_tech_bridge_extractor_v5_precise"
...
END_DATE = "2025/12/31"
OUTPUT_PREFIX = "pubmed_visceral_surgery_technology_precise_1980_2025_v5"
...
TECH_MODULES: Dict[str, List[str]] = {
    ...
    "energy_electrosurgery_ultrasonic_thermal": [
        "Electrocoagulation[Mesh]", "Lasers[Mesh]",
