...
TOOL = "visceral_surgery_tech_bridge_extractor_v2"

SEARCH_RETMAX = 10000       # PubMed ESearch batch size for IDs
FETCH_BATCH_SIZE = 200      # EFetch XML batch size
START_DATE = "1980/01/01"
END_DATE = "2025/12/31"
OUTPUT_PREFIX = "pubmed_visceral_surgery_technology_expanded_1980_2025"
...
def esearch_pmids(query: str) -> Tuple[int, List[str]]:
    ...
    first = eutils_post("esearch.fcgi", {
        "db": DB, "term": query, "retmode": "json", "retmax": "0", "usehistory": "n"
    })
    data = first.json().get("esearchresult", {})
